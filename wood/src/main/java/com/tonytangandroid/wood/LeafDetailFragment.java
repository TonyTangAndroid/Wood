...
public class LeafDetailFragment extends Fragment
    implements View.OnClickListener, TextUtil.AsyncTextProvider, TextWatcher {

  private static final String ARG_ID = "arg_id";
  private final BackgroundColorSpan colorSpan =
      new BackgroundColorSpan(SEARCHED_HIGHLIGHT_BACKGROUND_COLOR);
  private long id;
