...
class FormatUtils {
  ...
  public static void applyHighlightSpan(
      Spannable spannableString, List<Integer> indexes, int length) {
  ...
  public static List<Integer> highlightSearchKeyword(TextView textView, String searchKey) {
    ...
    if (body instanceof Spannable) {
      ...
      HighlightSpan spansToRemove[] =
          spannableBody.getSpans(0, spannableBody.length() - 1, HighlightSpan.class);
