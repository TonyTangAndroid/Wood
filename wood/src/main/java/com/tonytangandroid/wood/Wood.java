...
public class Wood {
   ...
   * @return An Intent for the main Wood Activity that can be started with {@link
   ...
   * @return The id of the added shortcut (<code>null</code> if this feature is not supported on the
