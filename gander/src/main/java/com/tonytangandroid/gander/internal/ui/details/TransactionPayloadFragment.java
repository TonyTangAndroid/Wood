...
import com.tonytangandroid.gander.internal.support.FormatUtils;
import com.tonytangandroid.gander.internal.support.GanderColorUtil;
import com.tonytangandroid.gander.internal.support.TextUtil;
...
import static com.tonytangandroid.gander.internal.support.GanderColorUtil.SEARCHED_HIGHLIGHT_BACKGROUND_COLOR;
...
public class TransactionPayloadFragment extends Fragment implements View.OnClickListener, TextUtil.AsyncTextProvider, TextWatcher {
    ...
    private GanderColorUtil colorUtil;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        colorUtil = GanderColorUtil.getInstance(getContext());
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.gander_frag_transaction_payload, container, false);
        bindView(rootView);
        return rootView;
    }
    ...
    private void bindView(View rootView) {
        ...
        search_bar = rootView.findViewById(R.id.gander_details_search_bar);
        View searchBarPrev = rootView.findViewById(R.id.gander_details_search_prev);
        View searchBarNext = rootView.findViewById(R.id.gander_details_search_next);
        View searchBarClose = rootView.findViewById(R.id.gander_details_search_close);
        et_key_word = rootView.findViewById(R.id.gander_details_search);
        tv_search_count = rootView.findViewById(R.id.gander_details_search_count);
    ...
    private void populateUI() {
        ...
        et_key_word.setHint(R.string.gander_search_request_hint);
        populateBody();
    }
    ...
    private void showSearch() {
        ...
        nested_scroll_view.setPadding(0, getResources().getDimensionPixelSize(R.dimen.gander_search_bar_height), 0, nested_scroll_view.getBottom());
        showKeyboard();
    }

    @Override
    public void onCreateOptionsMenu(Menu menu, MenuInflater menuInflater) {
        menuInflater.inflate(R.menu.gander_details_menu, menu);
    }
