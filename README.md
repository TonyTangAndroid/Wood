...
```gradle
debugImplementation 'com.github.TonyTangAndroid.Wood:wood:0.4.7'
releaseImplementation 'com.github.TonyTangAndroid.Wood:wood-no-op:0.4.7'
```
If you want this in library in both release and compile, then try this : 
```gradle
implementation 'com.github.TonyTangAndroid.Wood:wood:0.4.7'
```
